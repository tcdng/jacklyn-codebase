...
/**
 * List command of active supported locale.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
@Component("supportedlocalelist")
public class SupportedLocaleListCommand extends AbstractZeroParamsSystemListCommand {
