...
/**
 * Application menu entity page bean.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
public class ApplicationMenuPageBean extends BaseEntityPageBean<ApplicationMenu> {
    ...
    public ApplicationMenuPageBean() {
        super("$m{system.menu.hint}");
    }
