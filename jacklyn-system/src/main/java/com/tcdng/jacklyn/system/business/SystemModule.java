...
public interface SystemModule extends JacklynBusinessModule, StartupShutdownHook {
	 ...
	 *             if an error occurs
	 */
	Long createAuthentication(AuthenticationLargeData authenticationLargeData)
			throws UnifyException;
	 ...
	 *             if an error occurs
	 */
	<T> Map<T, Module> findModules(Class<T> keyClass, String keyName, ModuleQuery query)
			throws UnifyException;
	 ...
	 *             if an error occurs
	 */
	List<SystemControlState> findSystemControlStates(SystemParameterQuery query)
			throws UnifyException;
	 ...
	 *             if an error occurs
	 */
	ScheduledTaskLargeData loadScheduledTaskDocumentValues(
	 ...
	 *             if an error occurs
	 */
	Long createScheduledTaskHistory(Long scheduledTaskId, TaskStatus taskStatus,
	 ...
	 *             if an error occurs
	 */
	List<ScheduledTaskHist> findScheduledTaskHistory(ScheduledTaskHistQuery query)
			throws UnifyException;
