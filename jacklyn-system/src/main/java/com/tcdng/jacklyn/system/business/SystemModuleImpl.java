...
public class SystemModuleImpl extends AbstractJacklynBusinessModule implements SystemModule {
    ...
    public Long createScheduledTask(ScheduledTaskLargeData scheduledTaskFormData) throws UnifyException {
        ...
        getParameterBusinessModule().updateParameterValues(scheduledTask.getTaskName(), SCHEDULED_TASK, scheduledTaskId,
    ...
    public ScheduledTaskLargeData findScheduledTaskDocument(Long id) throws UnifyException {
        ...
        Inputs parameterValues = getParameterBusinessModule().fetchNormalizedInputs(scheduledTask.getTaskName(),
                SCHEDULED_TASK, id);
    ...
    public int updateScheduledTask(ScheduledTaskLargeData scheduledTaskFormData) throws UnifyException {
        ...
        getParameterBusinessModule().updateParameterValues(scheduledTask.getTaskName(), SCHEDULED_TASK,
    ...
    public int deleteScheduledTask(Long scheduledTaskId) throws UnifyException {
        ...
        getParameterBusinessModule().deleteParameterValues(taskName, SCHEDULED_TASK, scheduledTaskId);
            ...
            if (now.after(scheduledTaskTime) && isOkToRunOnWorkingDate(scheduledTask)) {
                ...
                if (grabClusterLock(taskLock)) {
                    ...
                    try {
                        ...
                        for (Input parameterValue : getParameterBusinessModule().fetchNormalizedInputs(
