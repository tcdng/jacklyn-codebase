...
/**
 * Authentication entity page bean.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
public class AuthenticationPageBean extends BaseEntityPageBean<Authentication> {
    ...
    public AuthenticationPageBean() {
        super("$m{system.authentication.hint}");
