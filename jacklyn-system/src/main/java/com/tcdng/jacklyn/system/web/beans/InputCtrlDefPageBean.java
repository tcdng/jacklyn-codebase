...
/**
 * Input control definition entity page bean.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
public class InputCtrlDefPageBean extends BaseEntityPageBean<InputCtrlDef> {
    ...
    public InputCtrlDefPageBean() {
        super("$m{system.inputctrldef.hint}");
    }
