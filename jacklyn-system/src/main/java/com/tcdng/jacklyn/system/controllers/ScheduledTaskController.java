...
public class ScheduledTaskController extends AbstractSystemRecordController<ScheduledTask> {
	...
	public ScheduledTaskController() {
		super(ScheduledTask.class, "system.scheduledtask.hint",
	...
	@Override
	protected void onPrepareView(ScheduledTask scheduledTaskData, boolean onPaste)
		...
		boolean isDisabled = ManageRecordModifier.VIEW == getMode()
				|| ManageRecordModifier.DELETE == getMode();
