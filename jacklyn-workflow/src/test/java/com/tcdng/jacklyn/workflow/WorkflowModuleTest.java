...
public class WorkflowModuleTest extends AbstractJacklynTest {
    ...
    public void testPublishedWorkflowCategory() throws Exception {
        ...
        /* Categories */
        List<WfCategory> wfCategoryList = wbModule.findWfCategories(new WfCategoryQuery().name("customerCategory"));
    ...
    public void testFindWorkflowItemHistory() throws Exception {
        ...
        WfItemObject workflowItem = wbModule.findWorkflowItem(wfItemId);
        WfItemHistObject workflowItemHist = wbModule.findWorkflowItemHistory(workflowItem.getWfItemHistId(), false);
    ...
    public void testGrabWorkflowItem() throws Exception {
        ...
        List<Long> grabItemIdList = wbModule.grabCurrentUserWorkItems("customerCategory.custOnboarding.custApproval");
    ...
    public void testApplyWorkflowAction() throws Exception {
        ...
        Long gWfItemId = wbModule.grabCurrentUserWorkItems("customerCategory.custOnboarding.custApproval").get(0);
    ...
    public void testApplyExtensionPolicy() throws Exception {
        TestOpenAccountPolicyLogic testOpenAccountPolicyLogic = (TestOpenAccountPolicyLogic) getComponent(
                "testopenaccount-policylogic");
    ...
    private void publish(WfCategoryConfig wfCategoryConfig) throws Exception {
        TaskMonitor taskMonitor = getWorkflowModule().startWorkflowCategoryPublication(wfCategoryConfig, true);
