...
/**
 * Workflow publish category page bean.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
public class WfPublishCategoryPageBean extends BasePageBean {

    private byte[] wfCategoryBin;

    private boolean activate;

    public WfPublishCategoryPageBean() {
        super("managePublishWorkflowPanel");
    }
