...
/**
 * Abstract base location service record management page controller.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
public abstract class AbstractLocationFormController<T extends BaseEntityPageBean<U>, U extends BaseEntity>
        extends BaseEntityFormController<T, Long, U> {

    @Configurable
    private LocationService locationService;

    public AbstractLocationFormController(Class<T> pageBeanClass, Class<U> entityClass, int modifier) {
