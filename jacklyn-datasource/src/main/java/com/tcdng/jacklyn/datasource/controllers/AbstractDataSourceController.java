...
/**
 * Abstract base page controller for data source module.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
public abstract class AbstractDataSourceController extends BasePageController {

    @Configurable
    private DataSourceService dataSourceService;

    public AbstractDataSourceController(boolean secured, boolean readOnly) {
