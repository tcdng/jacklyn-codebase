...
/**
 * Email notification channel list command.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
@Tooling(description = "Email Notification Channel List")
@Component("emailnotificationchannellist")
public class EmailNotificationChannelListCommand extends AbstractZeroParamsNotificationListCommand {
