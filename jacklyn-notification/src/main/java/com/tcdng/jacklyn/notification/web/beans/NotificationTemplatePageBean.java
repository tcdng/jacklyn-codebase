...
/**
 * Notification template page bean.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
public class NotificationTemplatePageBean extends BaseEntityPageBean<NotificationTemplate> {
    ...
    public NotificationTemplatePageBean() {
        super("$m{notification.notificationtemplate.hint}");
    }
