 ...
 * @since 1.0
 */
public abstract class AbstractNotificationFormController<T extends BaseEntityPageBean<U>, U extends BaseEntity>
        extends BaseEntityFormController<T, Long, U> {

    @Configurable
    private NotificationService notificationService;

    public AbstractNotificationFormController(Class<T> pageBeanClass, Class<U> entityClass, int modifier) {
