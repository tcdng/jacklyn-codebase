...
/**
 * Notification channel page bean.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
public class NotificationChannelPageBean extends BaseEntityPageBean<NotificationChannel> {
    ...
    public NotificationChannelPageBean() {
        super("$m{notification.notificationchannel.hint}");
    }
