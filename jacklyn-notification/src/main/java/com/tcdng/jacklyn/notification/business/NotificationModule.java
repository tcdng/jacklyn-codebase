...
/**
 * Message business module.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
public interface NotificationModule extends JacklynBusinessModule {
	 ...
	 *             if an error occurs
	 */
	List<NotificationChannel> findNotificationChannels(NotificationChannelQuery query)
			throws UnifyException;
	 ...
	 *             if an error occurs
	 */
	Long createNotificationTemplate(NotificationTemplate notificationTemplate)
			throws UnifyException;
	 ...
	 */
	NotificationTemplate findNotificationTemplate(Long notificationTemplateId)
			throws UnifyException;
	 ...
	 *             if an error occurs
	 */
	NotificationTemplate findNotificationTemplate(String moduleName, String name)
			throws UnifyException;
	 ...
	 *             if an error occurs
	 */
	List<NotificationTemplate> findNotificationTemplates(NotificationTemplateQuery query)
			throws UnifyException;
	 ...
	 *             if an error occurs
	 */
	int setNotificationStatus(List<Long> notificationIds, NotificationStatus status)
			throws UnifyException;
