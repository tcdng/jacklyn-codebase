...
public interface WfDocumentErrorConstants {
    ...
    /**
     * Workflow document field with invalid data type. Index = {0}, name = {1}, type
     * = {2}
     */
    ...
    /**
     * Workflow document classifier with name already exists. Index = {0}, name =
     * {1}
     */
    ...
    /**
     * Workflow document classifier filter has no field. Index = {0}, classifier =
     * {1}.
     */
    String WFDOCUMENT_CLASSIFIERFILTER_NO_FIELD = "WFDOC_0012";

    /**
     * Workflow document classifier filter has no operation. Index = {0}, classifier
     * = {1}.
     */
    String WFDOCUMENT_CLASSIFIERFILTER_NO_OP = "WFDOC_0013";

    /**
     * Workflow document classifier filter refers to unknown field. Index = {0},
     * classifier = {1}, field = {2}.
     */
    String WFDOCUMENT_CLASSIFIERFILTER_UNKNOWN_FIELD = "WFDOC_0014";

    /**
     * Workflow document classifier filter refers to complex field. Index = {0},
     * classifier = {1}, field = {2}.
     */
    ...
    /**
     * Workflow document attachment with name already exists. Index = {0}, name =
     * {1}
     */
    ...
    /**
     * Workflow document bean mapping with name already exists. Index = {0}, name =
     * {1}
     */
    ...
    /**
     * Workflow document bean mapping has no field mappings. Index = {0}, name =
     * {1}.
     */
    String WFDOCUMENT_BEANMAPPING_NO_MAPPINGS = "WFDOC_0021";

    /**
     * Workflow document field mapping has no document field. Index = {0}, bean
     * mapping = {1}.
     */
    String WFDOCUMENT_FIELDMAPPING_NO_DOCFIELD = "WFDOC_0022";

    /**
     * Workflow document field mapping has no bean field. Index = {0}, bean mapping
     * = {1}.
     */
    String WFDOCUMENT_FIELDMAPPING_NO_BEANFIELD = "WFDOC_0023";

    /**
     * Workflow document field mapping refers to unknown document field. Index =
     * {0}, bean mapping = {1}, field name = {2}.
     */
    ...
    /**
     * Workflow document section unknown complex binding. Index = {0}, name = {1},
     * binding = {2}
     */
    String WFDOCUMENT_SECTION_UNKNOWN_COMPLEX = "WFDOC_0030";

    /**
     * Workflow document section field binding already exists. Index = {0},
     * sectionName = {1}, binding = {2}
     */
    String WFDOCUMENT_FORMFIELD_MULTIPLE_BINDING = "WFDOC_0031";

    /**
     * Workflow document section field has no binding. Index = {0}, sectionName =
     * {1}
     */
    String WFDOCUMENT_FORMFIELD_NO_BINDING = "WFDOC_0032";

    /**
     * Workflow document section field binding refers to unknown field. Index = {0},
     * sectionName = {1}, binding = {2}
     */
    String WFDOCUMENT_FORMFIELD_UNKNOWN_FIELD = "WFDOC_0033";

    /**
     * Workflow document section field binding refers to non-complex subfield. Index
     * = {0}, sectionName = {1}, binding = {2}
     */
    String WFDOCUMENT_FORMFIELD_NOT_COMPLEX_FIELD = "WFDOC_0034";

    /**
     * Workflow document section field binding has no UPL editor. Index = {0},
     * sectionName = {1}, binding = {2}
     */
