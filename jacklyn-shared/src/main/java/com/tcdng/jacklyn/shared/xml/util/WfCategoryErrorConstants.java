...
public interface WfCategoryErrorConstants {
	...
	/**
	 * Workflow category document version not compatible. Document index = {0}, category version = {1}, document version = {2}.
	 */
	String WFCATEGORY_DOCUMENT_VERSION_NOT_COMPATIBLE = "WFCAT_000D";

	/**
	 * Workflow category template version not compatible. Template index = {0}, category version = {1}, template version = {2}.
	 */
