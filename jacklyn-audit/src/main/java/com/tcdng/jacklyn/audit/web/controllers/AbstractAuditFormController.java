 ...
 * @since 1.0
 */
public abstract class AbstractAuditFormController<T extends BaseEntityPageBean<U>, U extends BaseEntity>
        extends BaseEntityFormController<T, Long, U> {

    @Configurable
    private AuditService auditService;

    public AbstractAuditFormController(Class<T> pageBeanClass, Class<U> entityClass, int modifier) {
