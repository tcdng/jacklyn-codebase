 ...
 * @since 1.0
 */
public interface FileModule extends JacklynBusinessModule {
	 ...
	 *             if an error occurs
	 */
	List<FileTransferConfig> findFileTransferConfigs(FileTransferConfigQuery query)
			throws UnifyException;
	 ...
	 *             if an error occurs
	 */
	byte[] readRemoteBlock(Long fileTransferConfigId, Date workingDt, String filename,
	 ...
	 *             if an error occurs
	 */
	int updateFileInboxItemsReadStatus(FileInboxQuery query, FileInboxReadStatus readStatus)
			throws UnifyException;
	 ...
	 *             if an error occurs
	 */
	List<BatchFileDefinition> findBatchFileDefinitions(BatchFileDefinitionQuery query)
			throws UnifyException;
	 ...
	 *             if an error occurs
	 */
	List<BatchFileReadConfig> findBatchFileReadConfigs(BatchFileReadConfigQuery query)
			throws UnifyException;
	 ...
	 *             if an error occurs
	 */
	BatchFileReadConfigLargeData loadBatchFileReadConfigDocumentValues(
	 ...
	 *             if an error occurs
	 */
	BatchFileReadInputParameters getBatchFileReadInputParameters(Long batchUploadConfigId)
			throws UnifyException;
	 ...
	 *             if an error occurs
	 */
	Map<String, Object> getBatchFileReadConfigExecutionParameters(Long batchFileReadConfigId)
			throws UnifyException;
}
