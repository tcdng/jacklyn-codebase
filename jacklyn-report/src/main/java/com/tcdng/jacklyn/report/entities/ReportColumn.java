...
@Table(
        name = "JKREPORTCOLUMN",
        uniqueConstraints = { @UniqueConstraint({ "reportConfigurationId", "reportableFieldId" }) })
public class ReportColumn extends BaseEntity {
    ...
    @ListOnly(key = "reportableFieldId", property = "formatter")
    private String fieldFormatter;

    @ListOnly(key = "reportableFieldId", property = "horizontalAlign")
    private String fieldHorizontalAlign;
    ...
    public String getFieldHorizontalAlign() {
        return fieldHorizontalAlign;
    }

    public void setFieldHorizontalAlign(String fieldHorizontalAlign) {
        this.fieldHorizontalAlign = fieldHorizontalAlign;
    }
