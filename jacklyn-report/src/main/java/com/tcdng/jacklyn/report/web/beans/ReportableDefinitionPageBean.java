...
/**
 * Reportable definition page bean.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
public class ReportableDefinitionPageBean extends BaseEntityPageBean<ReportableDefinition> {

    private Long searchModuleId;

    private RecordStatus searchStatus;

    public ReportableDefinitionPageBean() {
        super("$m{report.reportabledefinition.hint}");
    }
