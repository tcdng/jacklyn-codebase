...
/**
 * Report business module.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
public interface ReportModule extends JacklynBusinessModule, ReportProvider {
	 ...
	 *             if an error occurs
	 */
	List<ReportableDefinition> findReportables(ReportableDefinitionQuery query)
			throws UnifyException;
