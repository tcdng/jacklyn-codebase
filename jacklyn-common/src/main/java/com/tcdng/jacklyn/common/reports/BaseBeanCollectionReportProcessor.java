...
/**
 * Convenient abstract base class for bean collection report processors.
 * 
 * @author The Code Department
 * @since 1.0.0
 */
public abstract class BaseBeanCollectionReportProcessor<T> extends AbstractBeanCollectionReportProcessor<T> {
