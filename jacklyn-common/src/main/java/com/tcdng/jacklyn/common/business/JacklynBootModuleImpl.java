...
import com.tcdng.unify.core.application.AbstractBootModule;
...
/**
 * Jacklyn boot business module.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
@Component(CommonModuleNameConstants.JACKLYNBOOTMODULE)
public class JacklynBootModuleImpl extends AbstractBootModule<ModuleConfig> {
