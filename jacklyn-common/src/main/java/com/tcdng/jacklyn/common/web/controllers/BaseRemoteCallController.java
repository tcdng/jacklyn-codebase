...
/**
 * Common base class for all remote call controllers.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
@Gateway(CommonModuleNameConstants.JACKLYNAPPLICATIONSERVICEGATE)
public abstract class BaseRemoteCallController extends AbstractRemoteCallController {
