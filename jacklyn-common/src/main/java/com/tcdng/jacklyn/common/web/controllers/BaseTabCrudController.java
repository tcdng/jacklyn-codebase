...
public abstract class BaseTabCrudController<T extends Entity, U> extends BaseCrudController<T, U> {

    public BaseTabCrudController(Class<T> entityClass, String hint, int modifier) {
        super(entityClass, hint, modifier);
    }

    @Override
    protected void setCrudViewerEditable(boolean editable) throws UnifyException {
        setEditable("crudViewPanel", editable);
    }
