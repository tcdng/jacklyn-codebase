 ...
 * @since 1.0
 */
public abstract class AbstractIntegrationFormController<T extends BaseEntityPageBean<U>, U extends BaseEntity>
        extends BaseEntityFormController<T, Long, U> {

    @Configurable
    private IntegrationService integrationService;

    public AbstractIntegrationFormController(Class<T> pageBeanClass, Class<U> entityClass, int modifier) {
