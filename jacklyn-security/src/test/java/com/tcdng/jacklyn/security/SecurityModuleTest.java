...
public class SecurityModuleTest extends AbstractJacklynTest {
    ...
    public void testUpdateRolePrivileges() throws Exception {
        ...
        List<Long> privilegeIdList = securityModule
    ...
    public void testChangeUserPasswordHistory() throws Exception {
        ...
        SystemModule systemModule = (SystemModule) this.getComponent(SystemModuleNameConstants.SYSTEMBUSINESSMODULE);
        systemModule.setSysParameterValue(SecurityModuleSysParamConstants.ENABLE_PASSWORD_HISTORY, Boolean.TRUE);
    ...
    public void testChangeUserPasswordHistoryExpired() throws Exception {
        ...
        SystemModule systemModule = (SystemModule) this.getComponent(SystemModuleNameConstants.SYSTEMBUSINESSMODULE);
        systemModule.setSysParameterValue(SecurityModuleSysParamConstants.ENABLE_PASSWORD_HISTORY, Boolean.TRUE);
        systemModule.setSysParameterValue(SecurityModuleSysParamConstants.PASSWORD_HISTORY_LENGTH, 2);
    ...
    public void testSetCurrentUserRole() throws Exception {
        ...
        List<UserRole> userRoleList = securityModule.findUserRoles(new UserRoleQuery().userId(userId));
