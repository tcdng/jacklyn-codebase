...
public class SecurityModuleImpl extends AbstractJacklynBusinessModule implements SecurityModule {
    ...
    public int updateRoleWorkflowSteps(Long roleId, List<Long> wfStepIdList) throws UnifyException {
        ...
        if (!DataUtils.isBlank(wfStepIdList)) {
            ...
            List<WfStep> wfStepList = workflowModule
    ...
    public void changeUserPassword(String oldPassword, String newPassword) throws UnifyException {
        ...
        if (systemModule.getSysParameterValue(boolean.class, SecurityModuleSysParamConstants.ENABLE_PASSWORD_HISTORY)) {
    ...
    private String generatePassword(User user, String sysParamNotificationTemplateName) throws UnifyException {
        PasswordGenerator passwordGenerator = (PasswordGenerator) getComponent(systemModule
    ...
    private String getUserRoleThemeResourcePath(Long userRoleId) throws UnifyException {
        ...
        Long themeId = null;
        if (systemModule.getSysParameterValue(boolean.class, SecurityModuleSysParamConstants.ENABLE_USER_THEMES)) {
