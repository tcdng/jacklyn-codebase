 ...
 * @since 1.0
 */
public abstract class AbstractSecurityFormController<T extends BaseEntityPageBean<U>, U extends BaseEntity>
        extends BaseEntityFormController<T, Long, U> {

    @Configurable
    private SecurityService securityService;

    public AbstractSecurityFormController(Class<T> pageBeanClass, Class<U> entityClass, int modifier) {
