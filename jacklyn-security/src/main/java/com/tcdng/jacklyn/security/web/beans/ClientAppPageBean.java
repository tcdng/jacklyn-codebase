...
/**
 * Client application page bean.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
public class ClientAppPageBean extends BaseEntityPageBean<ClientApp> {
    ...
    public ClientAppPageBean() {
        super("$m{security.clientapp.hint}");
    ...
    public ClientAppLargeData getClipboardLargeData() {
        return clipboardLargeData;
    }

    public void setClipboardLargeData(ClientAppLargeData clipboardLargeData) {
