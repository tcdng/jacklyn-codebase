...
public class ArchivingBusinessModuleTest extends AbstractJacklynTest {
    ...
    public void testFindArchivables() throws Exception {
        ...
        List<ArchivableDefinition> archivableList = archivingModule.findArchivableDefinitions(query);
    ...
    public void testFindFileArchiveConfigById() throws Exception {
        ...
        FileArchiveConfig fetchedFileArchiveConfig = archivingModule.findFileArchiveConfig(fileArchiveConfigId);
    ...
    public void testUpdateFileArchiveConfig() throws Exception {
        ...
        FileArchiveConfig updatedFileArchiveConfig = archivingModule.findFileArchiveConfig(fileArchiveConfigId);
    ...
    public void testRetriveArchivedBlob() throws Exception {
        ...
        byte[] archivedImage = archivingModule.retriveArchivedBlob(TestChequeImage.class.getName(), "image",
                testChequeImageId);
    ...
    public void testRetriveArchivedBlobMultipleItems() throws Exception {
        ...
        archivedImage = archivingModule.retriveArchivedBlob(TestChequeImage.class.getName(), "image",
                testChequeImageId2);
        assertNotNull(archivedImage);
    ...
    public void testRetriveArchivedClob() throws Exception {
        ...
        String archivedTemplate = archivingModule.retriveArchivedClob(TestChequeImage.class.getName(), "template",
                testChequeImageId);
