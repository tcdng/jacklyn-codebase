 ...
 * @since 1.0
 */
public abstract class AbstractArchivingFormController<T extends BaseEntityPageBean<U>, U extends BaseEntity>
        extends BaseEntityFormController<T, Long, U> {

    @Configurable
    private ArchivingService archivingService;

    public AbstractArchivingFormController(Class<T> pageBeanClass, Class<U> entityClass, int modifier) {
