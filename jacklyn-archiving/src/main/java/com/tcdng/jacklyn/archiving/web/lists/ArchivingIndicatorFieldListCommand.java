...
/**
 * Archiving indicator field list command.
 * 
 * @author Lateef Ojulari
 * @since 1.0
 */
@Component("archivingindicatorfieldlist")
public class ArchivingIndicatorFieldListCommand extends AbstractArchivingListCommand<ArchivingParams> {

    public ArchivingIndicatorFieldListCommand() {
    ...
    public List<? extends Listable> execute(Locale locale, ArchivingParams params) throws UnifyException {
        if (QueryUtils.isValidLongCriteria(params.getArchivableDefId())) {
            ...
            query.fieldType(ArchivingFieldType.BOOLEAN);
